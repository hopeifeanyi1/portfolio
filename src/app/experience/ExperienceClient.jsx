...
const experiences = [
  ...
  },
  {
    ...
    description:
      "Led frontend development and engineering team as Acting CTO during internship.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Worked across backend and frontend for a US-based job application platform.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Contributed to mission-critical internal platforms at Nigeria's largest telecom company.",
    achievements: [
          ...
          >
            ...
            <ul className="space-y-1 mb-4">
              {experience.achievements.map((achievement, i) => (
                <li
                  key={i}
                  className="text-gray-600 dark:text-gray-400 text-sm pl-4"
                >
                  • {achievement}
                </li>
              ))}
      ...
      >
        ...
        <ul className="space-y-2">
          {awards.map((award, index) => (
            <li
              key={index}
              className="text-gray-600 dark:text-gray-400 pl-4"
            >
              • {award}
            </li>
          ))}
